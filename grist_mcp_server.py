...
def main():
    ...
    try:
        from grist_tools_integration import register_all_tools
        logger.info("Module d'outils supplémentaires importé avec succès")
    except ImportError as e:
        logger.warning(f"Module d'outils supplémentaires non trouvé: {e}")

    # Importation et initialisation de l'outil de commandes de Noël - DÉSACTIVÉ
    # try:
    ...
    # Importation et initialisation des outils de formulaires Grist - DÉSACTIVÉ
    # try:
    #     from grist_form_integration import register_form_tools_to_mcp
    #     register_form_tools_to_mcp(mcp)
    #     logger.info("Module de formulaires Grist chargé avec succès")
    # except ImportError as e:
    #     logger.error(f"Erreur lors de l'importation du module de formulaires Grist: {e}")
    ...
    # Enregistrement des outils supplémentaires
    try:
        # Utiliser l'import local pour éviter les problèmes de portée
        from grist_tools_integration import register_all_tools
